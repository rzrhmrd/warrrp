...
def generate_warp_config(top_servers, last_update_time):
    ...
    warp_config = (
        f"warp://{top_servers[0]}?ifp=40-80&ifps=40-100&ifpd=4-8&ifpm=m4#MCI-IR&&detour=warp://{top_servers[1]}#MCI-DE\n"
        f"warp://{top_servers[0]}?ifp=20-35&ifps=5-35&ifpd=5-35&ifpm=m3#Irancell-IR&&detour=warp://{top_servers[1]}#Irancell-DE"
    )
