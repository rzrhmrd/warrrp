...
def generate_warp_config(clean_ips, last_update_time):
    ...
    warp_config = (
        f'warp://{clean_ips[0]}?pk=8FTSXDA02NbnunQndj56OjXIVODnOsTWFWOeU/HDZV0=&peer_pk=bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=&reserved=168,77,246&ifp=80-150&ifps=80-150&ifpd=20-25&mtu=1306#IR&&detour=warp://{clean_ips[1]}#DE'
    )
